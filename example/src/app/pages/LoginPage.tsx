        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="mt-4 text-center space-y-2">
              <Link to="/signin" className="block text-sm text-gray-500 hover:text-gray-700">
                Try alternative sign in page
              </Link>
              <Link to="/admin" className="block text-sm text-gray-500 hover:text-gray-700">
                Admin Login
              </Link>
            </div>
          </div>
